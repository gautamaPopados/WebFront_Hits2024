...
import { getInspectionChain, getInspections, getRootsICD } from "../api.js";
...
export default class extends AbstractView {
    ...
    async loadInspections() {
        ...
        const [inspections, pagination] = await getInspections(queryString);
